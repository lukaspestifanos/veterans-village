export const site = {
  ...
  hoursShort: 'Mon to Fri, 9 AM to 5 PM',
...
export const values = [
  { title: 'Reliability', text: 'A trustworthy partner to veterans, their families, and our community partners.' },
  { title: 'Self-sufficiency', text: 'Opportunities for veterans and their families to build independent, stable lives.' },
  { title: 'Advocacy', text: 'We advocate for the rights and well-being of the veterans and seniors we serve.' },
  { title: 'Partnership', text: 'We work closely with other nonprofits to ensure effective, reliable care.' },
]
