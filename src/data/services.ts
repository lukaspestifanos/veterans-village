...
export const services: Service[] = [
  {
    ...
    text: 'Safe, secure apartment homes for veterans and seniors across nine communities in Washington, with services extending to Alabama.',
  ...
  },
  {
    ...
    text: 'We do not provide behavioral health services directly. We coordinate them, connecting veterans and seniors with trusted providers so they have the support they need through life transitions.',
    cta: { label: 'Ask about behavioral health', to: '/contact?topic=services' },
  },
  {
    slug: 'food',
    icon: 'basket',
